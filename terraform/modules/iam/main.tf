...
# Attach EKS Cluster Policy to Admin Role
...
# Attach EKS Service Policy to Service Role
...
resource "aws_iam_role_policy_attachment" "eks_node_group_container_registry_policy" {
